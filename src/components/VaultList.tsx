...
export const VaultList: React.FC<VaultListProps> = ({ category = 'all', items, searchTerm, onDeleteItem }) => {
    ...
    // const [items, setItems] = useState<VaultItem[]>([]); // Removed local state
    // const [isLoading, setIsLoading] = useState(true); // Removed local loading
    ...
    const filteredItems = items.filter(item => {
        ...
        return matchesSearch && item.type === category;
    });
                                ...
                                {!isMobile && (
                                    <div style={{ display: 'flex', gap: '0.5rem' }}>
                                        ...
                                        <button
                                            ...
                                            className="btn"
                                            style={{ padding: '0.5rem 1.5rem', border: '1px solid #404040', color: 'var(--color-ev-red)', cursor: 'pointer', background: 'transparent' }}
                                        >
                                            DELETE
                                        </button>
                                    </div>
