...
export const Sidebar: React.FC<SidebarProps> = ({ view, setView, onLogout, totalItems, username }) => {
            ...
            <aside style={{
                ...
                <div style={{ padding: '1.5rem', borderBottom: '1px solid #262626', display: 'flex', alignItems: 'center', gap: '1rem' }}>
                    ...
                    <div style={{ minWidth: 0, flex: 1 }}>
                        ...
                        <div style={{ fontSize: '0.75rem', color: '#737373', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>Secured User</div>
                    </div>
                </div>
